...
echo "/* This file is auto-generated by scripts/generate_wordlist.sh */" > "$OUTPUT_FILE"
echo "#ifndef WORDLIST_H" >> "$OUTPUT_FILE"
echo "#define WORDLIST_H" >> "$OUTPUT_FILE"
echo "" >> "$OUTPUT_FILE"
echo "#define WORD_COUNT 2048" >> "$OUTPUT_FILE"
echo "" >> "$OUTPUT_FILE"
...
echo "" >> "$OUTPUT_FILE"
echo "#endif /* WORDLIST_H */" >> "$OUTPUT_FILE"
